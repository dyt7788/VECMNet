...
if __name__ == '__main__':
    ...
    sub = '/root/autodl-tmp/RDE-main/2024-CVPR-RDE/run_logs/ICFG-PEDES/20251104_144142_VECM_TAL+sr0.3_tau0.015_margin0.1_n0.5'
    parser.add_argument("--config_file", default=f'{sub}/configs.yaml')
    args = parser.parse_args()
    args = load_train_configs(args.config_file)
    args.training = False
    logger = setup_logger('VECM', save_dir=args.output_dir, if_train=args.training)
    logger.info(args)
    device = "cuda"
    args.output_dir =sub
